...
parser.add_argument('--path', default="oviIN/clustering_v", help="Explicit path; using this ignores positional argument")
parser.add_argument('--neuron_csv', default="connections.txt", help="Name of neuron csv, if different from traced-neurons.csv")
parser.add_argument('--edge_csv', default="edge_ovi.txt", help="Name of edge csv, if different from traced-total-connections.csv")
parser.add_argument('--cluster_csv', default="cluster_info.txt", help="Name of edge csv, if different from default")
parser.add_argument('--cluster_dir', default='oviIN/clustering_v', help="Directory with cluster info. Gets version appended")
parser.add_argument('--output_dir', default="oviIN/preprocessed-v", help="Output directory, which will have version appended. Created if doesn't exist.")
