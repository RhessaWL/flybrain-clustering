...
parser.add_argument('--path', default="APL/clustering_outputs_v", help="Explicit path; using this ignores positional argument")
parser.add_argument('--neuron_csv', default="apl_out_key.txt", help="Name of neuron csv, bodyIds (key.txt)")
parser.add_argument('--edge_csv', default="apl_out_formatted.txt", help="Name of edge csv, if different from traced-total-connections.csv")
parser.add_argument('--cluster_csv', default="cluster_info_o.xlsx", help="Name of edge csv, if different from default")
parser.add_argument('--cluster_dir', default='APL/clustering_outputs_v', help="Directory with cluster info. Gets version appended")
parser.add_argument('--output_dir', default="APL/preprocessed_outputs-v", help="Output directory, which will have version appended. Created if doesn't exist.")
